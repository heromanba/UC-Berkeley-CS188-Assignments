            ...
            while True:
                if agentIndex == 0: 
                    ...
                    try:
                        ...
                        if action not in gameState.getLegalActions(self.gameRules):
                            print("***\tERROR: Action of Player %d is illegal!\t****" % (agentIndex))
                            print("***\tCurrent Board State!\t****")
                            gameState.printBoards(self.gameRules)
                            print("***\tAction Return by Player %d is %s!\t****" % (agentIndex, action))
                            return 0, False
